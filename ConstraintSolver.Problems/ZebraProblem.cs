...
namespace ConstraintSolver.Problems
{
  public class ZebraProblem
  {
    ...
    public ZebraProblem(AbstractProblem problem)
    {
      ...
      problem.AddConstrainedVariables((a, b) => new InequalityConstraint(a, b), englishman, spaniard, ukrainian, norwegian, japanese);
      ...
      problem.AddConstrainedVariables((a, b) => new InequalityConstraint(a, b), coffee, tea, milk, orangeJuice, water);
      ...
      problem.AddConstrainedVariables((a, b) => new InequalityConstraint(a, b), oldGold, kools, chesterfields, luckyStrike, parliaments);
